...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/add_location.css') }}">
    ...
    <div class="container">
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" name="branch_name" class="form-control" placeholder="Insert Title" value="{{ old('branch_name') }}">
            </div>
        </div>
        <div class="col">
            <div class="form-group has-danger">
                <label class="control-label">Alamat</label>
                <input type="text" name="address" class="form-control" placeholder="Lorem Ipsum" value="{{ old('address') }}">
            </div>
        </div>
        <div class="col">
            <div class="form-group has-danger">
                <label class="control-label">Link GPS</label>
                <input type="text" name="gmaps" class="form-control" placeholder="Lorem Ipsum" value="{{ old('gmaps') }}">
            </div>
        </div>
        <div class="col">
            <div class="form-group has-danger">
