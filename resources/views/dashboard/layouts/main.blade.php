...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/dashboard/partial.css') }}">
   ...
   <link rel="stylesheet" href="css/dashboard/contact.css">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,300;0,700;1,700&display=swap"
        rel="stylesheet">
